...
#SBATCH --output load_tsv_job%j.out
#SBATCH --error load_tsv_job%j.err
...
python -u /home/neal.nevyn/blue_guralnick/share/gbif_data/scripts/py/gbif_download.py
