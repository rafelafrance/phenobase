...
#SBATCH --job-name=flower_inference_2
...
python3 /blue/guralnick/rafe.lafrance/phenobase/phenobase/model_infer.py \
    ...
    --output-csv /home/rafe.lafrance/blue/phenobase/data/infer/flower_inference_1000000_0000000_2.csv \
...
python3 /blue/guralnick/rafe.lafrance/phenobase/phenobase/model_infer.py \
    ...
    --image-dir /blue/guralnick/share/phenobase_specimen_data/images \
    --bad-taxa /home/rafe.lafrance/blue/phenobase/datasets/remove_flowers.csv \
    --output-csv /home/rafe.lafrance/blue/phenobase/data/infer/flower_inference_1000000_1000000_2.csv \
    --checkpoint /blue/guralnick/rafe.lafrance/phenobase/data/models/best_3combo_fract/vit_384_lg_flowers_f1_a_checkpoint-19199 \
    --image-size 384 \
    --limit 1000000 \
    --offset 1000000 \
...
python3 /blue/guralnick/rafe.lafrance/phenobase/phenobase/model_infer.py \
    ...
    --image-dir /blue/guralnick/share/phenobase_specimen_data/images \
    --bad-taxa /home/rafe.lafrance/blue/phenobase/datasets/remove_flowers.csv \
    --output-csv /home/rafe.lafrance/blue/phenobase/data/infer/flower_inference_1000000_2000000_2.csv \
    --checkpoint /blue/guralnick/rafe.lafrance/phenobase/data/models/best_3combo_fract/vit_384_lg_flowers_f1_a_checkpoint-19199 \
    --image-size 384 \
    --limit 1000000 \
    --offset 2000000 \
